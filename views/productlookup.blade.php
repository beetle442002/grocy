...
@section('title', $__t('Import product'))
...
try{
	$off_product = $api->getProduct($junk['barcode']);
	$off_product = $off_product->getData();
}
catch (Exception $e) {
    $off_product['product_name'] = $e->getMessage();
}
catch (InvalidArgumentException $e) {
    echo $e->getMessage();
}
catch(ProductNotFoundException $e) {
	$off_product['product_name'] = "Not Found";
  //	echo $e;
}
...
<div class="row">
	...
	<div class="col-lg-6 col-xs-12">
		<div class="row" style="margin:0px">
			...
			<div class="col" style="border:1px solid black; padding-top: 15px; padding-bottom: 15px;">
				<div class="row"><h2><? echo("Product"); ?></h2></div>
			<div class="row"><span style="margin-left: 5px;"><h6>Product:&nbsp;</h6> </span><span><? echo($off_product['product_name']); ?></span> </div>
			<div class="row"><span style="margin-left: 5px;"><h6>Brand:&nbsp;</h6> </span><span><? echo($off_product['brands']); ?></span> </div>
		</div>
		</div>
	</div>
